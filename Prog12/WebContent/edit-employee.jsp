		...
		<table>
			...
			<tr>
				<th>Full time Employee</th>
						...
						<c:if test="${employee.fullTimeEmployee eq 't'}">checked="checked"</c:if>
						<c:if test="${employee.fullTimeEmployee eq 'nt'}"></c:if>></td>
			</tr>
			<tr>
				<th>Department</th>
				<td><select name="department" value="${employee.department }">
